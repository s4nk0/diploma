...
<head><base href="">
    ...
    <link href="{{asset("adminFiles/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css")}}" rel="stylesheet" type="text/css" />
    <link href="{{asset("adminFiles/assets/plugins/custom/datatables/datatables.bundle.css")}}" rel="stylesheet" type="text/css" />
    <!--end::Page Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(used by all pages)-->
    <link href="{{asset("adminFiles/assets/plugins/global/plugins.bundle.css")}}" rel="stylesheet" type="text/css" />
    <link href="{{asset("adminFiles/assets/css/style.bundle.css")}}" rel="stylesheet" type="text/css" />
            ...
            <div class="aside-menu flex-column-fluid">
                ...
                <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        ...
                        <div class="menu-item {{ Request::routeIs('admin.user.*') ? 'here show' : '' }}  menu-accordion">
...
{{--                                            <!--end::Svg Icon-->--}}
{{--										</span>--}}
{{--                                <span class="menu-title">Audio contents</span>--}}
{{--                            </a>--}}
{{--                        </div>--}}

{{--                        <div class="menu-item {{ Request::routeIs('admin.video.courses') ? 'here show' : '' }}  menu-accordion">--}}
{{--                            <a href="{{route('admin.video.courses')}}" class="menu-link">--}}
{{--										<span class="menu-icon">--}}
{{--											<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg")}}-->--}}
{{--											<span class="svg-icon svg-icon-2">--}}
{{--												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">--}}
...
{{--                                            <!--end::Svg Icon-->--}}
{{--										</span>--}}
{{--                                <span class="menu-title">Video contents</span>--}}
{{--                            </a>--}}
{{--                        </div>--}}

{{--                        <div class="menu-item {{ Request::routeIs('admin.settings.index') ? 'here show' : '' }}  menu-accordion">--}}
...
{{--                        </a>--}}
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        ...
                        <div class="d-flex align-items-stretch flex-shrink-0">
                            <!--begin::User menu-->
                            <livewire:admin.profile.user-menu />
                                <!--end::User menu-->
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
                                        <img src="{{asset("adminFiles/assets/media/avatars/300-14.jpg")}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{asset("adminFiles/assets/media/avatars/300-2.jpg")}}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{asset("adminFiles/assets/media/avatars/300-20.jpg")}}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                                        <img src="{{asset("adminFiles/assets/media/avatars/300-1.jpg")}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
                                        <img src="{{asset("adminFiles/assets/media/avatars/300-23.jpg")}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="{{asset("adminFiles/assets/media/svg/files/pdf.svg")}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="{{asset("adminFiles/assets/media/svg/files/doc.svg")}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="{{asset("adminFiles/assets/media/svg/files/css.svg")}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{asset("adminFiles/assets/media/stock/600x400/img-29.jpg")}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{asset("adminFiles/assets/media/stock/600x400/img-31.jpg")}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{asset("adminFiles/assets/media/stock/600x400/img-40.jpg")}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
                                        <img src="{{asset("adminFiles/assets/media/avatars/300-4.jpg")}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="symbol symbol-35px symbol-circle">
                                <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-25.jpg")}}" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Details-->
                            <div class="ms-3">
                ...
                <div class="d-flex justify-content-end mb-10">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Avatar-->
                            <div class="symbol symbol-35px symbol-circle">
                                <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-1.jpg")}}" />
                            </div>
                            <!--end::Avatar-->
                        </div>
                        <!--end::User-->
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{asset("adminFiles/assets/media/svg/card-logos/visa.svg")}}" alt="" class="h-25px" />
                                                <img src="{{asset("adminFiles/assets/media/svg/card-logos/mastercard.svg")}}" alt="" class="h-25px" />
                                                <img src="{{asset("adminFiles/assets/media/svg/card-logos/american-express.svg")}}" alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                        <!--end::Input wrapper-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{asset("adminFiles/assets/media/illustrations/sketchy-1/9.png")}}" alt="" class="mw-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                    ...
                    <div class="py-5">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-6.jpg")}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-5.jpg")}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-9.jpg")}}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-23.jpg")}}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-12.jpg")}}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-13.jpg")}}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{asset("adminFiles/assets/media/avatars/300-21.jpg")}}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="{{asset("adminFiles/assets/media/illustrations/sketchy-1/1.png")}}" alt="" class="w-100 h-200px h-sm-325px" />
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Empty-->
...
<script src="{{asset("adminFiles/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js")}}"></script>
<script src="{{asset("adminFiles/assets/plugins/custom/datatables/datatables.bundle.js")}}"></script>
<!--end::Page Vendors Javascript-->
<!--begin::Page Custom Javascript(used by this page)-->
<script src="{{asset("adminFiles/assets/js/widgets.bundle.js")}}"></script>
<script src="{{asset("adminFiles/assets/js/custom/widgets.js")}}"></script>
<script src="{{asset("adminFiles/assets/js/custom/apps/chat/chat.js")}}"></script>
<script src="{{asset("adminFiles/assets/js/custom/utilities/modals/upgrade-plan.js")}}"></script>
<script src="{{asset("adminFiles/assets/js/custom/utilities/modals/create-app.js")}}"></script>
<script src="{{asset("adminFiles/assets/js/custom/utilities/modals/users-search.js")}}"></script>
