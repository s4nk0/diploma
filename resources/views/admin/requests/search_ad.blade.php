            ...
            <div class="card-header bg-white border-bottom-0 d-flex justify-content-between">
                ...
                @can('update',$search_ad)
                    <div class="d-flex align-items-center">
                        <a href="{{route('admin.request.search_ad.accept',['search_ad'=>$search_ad])}}" title="Принять" class="btn btn-primary me-2">
                        ...
                        <div class="dropdown-center" title="Отклонить">
                            ...
                            <div class="dropdown-menu">
                                <form class="px-2 py-1" action="{{route('admin.request.search_ad.decline',['search_ad'=>$search_ad])}}" method="post">
                                    @csrf
